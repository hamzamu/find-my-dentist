...
// Get The Settings
// Get The Settings
App.getSetting = function (key,obj) {
    // console.log("GETSETTING DEBUG",key,obj)
    if(!key){
        return
    }
    ...
    var hasField = setting[key];

    if(setting && obj && hasField){
        // console.log('GETSETTING WITH OBJ : ',setting[key][obj])
        // console.log("GETSETTING DEBUG",setting)
